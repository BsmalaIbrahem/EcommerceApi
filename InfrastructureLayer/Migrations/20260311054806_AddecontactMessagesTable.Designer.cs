...
namespace InfrastructureLayer.Migrations
{
    ...
    [Migration("20260311054806_AddecontactMessagesTable")]
    partial class AddecontactMessagesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainLayer.Entities.AdTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.BrandTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.DiscountCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.DiscountProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.DiscountTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DiscountTranslation");
                });

            modelBuilder.Entity("DomainLayer.Entities.Languages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.PostTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.ProductTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InfrastructureLayer.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DomainLayer.Entities.AdTranslation", b =>
                {
                    ...
                    b.HasOne("DomainLayer.Entities.Languages", "Language")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainLayer.Entities.PostTranslation", b =>
                {
                    ...
                    b.HasOne("DomainLayer.Entities.Post", "Post")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InfrastructureLayer.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DomainLayer.Entities.Discount", b =>
                {
                    ...
                    b.Navigation("DiscountTranslations");
                });
